...
Find and kill {kill|Overseer Krow}
    #sub Head {dir|180} as much as possible
    #sub Head {dir|270}
...
Find and take {quest_text|Miasmeter}
    #sub Head {dir|270} as much as possible
Find and kill {kill|Justicar Casticus}, take {quest_text|Eyes of Zeal}
    #sub Head {dir|45} from {quest_text|Miasmeter}
...
➞ {arena|Sanctum of Innocence}, kill {kill|High Templar Avarius}
    #sub Head {dir|315} counter-clockwise spiral
{logout}
...
➞ {enter|1_5_7} #The Reliquary
    #sub Head {dir|225} find the plaza
    #sub Head {dir|180}
